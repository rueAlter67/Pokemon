...
public class Area{
    ...
    private ArrayList<CapturedCreature> CMasterInventory; 
    
    /**
     * This is the constructor the Player class 
     * @param CPlayer the Player who will play in the game
     * @param CMasterInventory the Inventory containing all of the Creatures in the  game
     */
    public Area(Player CPlayer, ArrayList<CapturedCreature> CMasterInventory){
	...
	public int loadArea(ArrayList<CapturedCreature> aCaptured, Inventory CInventory) {
        ...
        do{
            ...
            if(dChance <= 0.40 && bPlayer == true && nMovement != 5 ){
                ...
                int nIndex = 0;
                nIndex++;
                this.CEnemy = getRandomCreature(CInventory.getAllCapturedCreatures());
                this.CEnemy.setHealth(50);
                battle(this.CEnemy, CPlayer.getAllCapturedCreatures(), CInventory);
            } 
